...
\newcommand{\convthi}[5]         {{#1} \vDash_{th} {#2} \rightsquigarrow {#3};{#4};\highlight{#5}}
...
\newcommand{\convmust}[3]         {{#1} \vDash_{th} {#2}\rightsquigarrow {#3}}
...
\newcommand{\clstoptype}[6] {{#1};{#2};{#3} \vdash_{tm} {#4}:{#5};{#6}}
