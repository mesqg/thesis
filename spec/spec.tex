...
\begin{figure}
\begin{flushleft}
  \namedRuleform{ \elabTerm{\highlight{\thEnv}}{\imEnv}{\tyEnv}{\term}{\typeS_x}{\term'}}
                {}
\end{flushleft}
\[
\inferrule*[]
...
% { \imResiSubs{\overline{\type}}{\imEnv}{conv}{\type_1}{\type_2}{[conv \mapsto (\varphi_{rest}\;conv_{rest}) \circ (conv_{fst}\;\type_a\; \overline{\varphi_i\;cond_i} ))]}}
